...
function renderResults(list, mode) {
  ...
  list.forEach((bloco) => {
    ...
    node.querySelector('.bloco-address').textContent = `${bloco.endereco_concentracao || 'Endereço não informado'} (${bloco.bairro || 'Bairro não informado'})${bloco.locationApproximate ? ' • localização aproximada' : ''}`;
